...
// one spi transfer for each byte
  ...
  for (i = 0 ; i < length ; i++){
    ...
    //std::cout << spi[i].tx_buf << ", ";
    //std::cout << spi[i].rx_buf << ", ";
    //std::cout << spi[i].len << ", ";
    //std::cout << spi[i].delay_usecs << ", ";
    //std::cout << spi[i].speed_hz << ", ";
    //std::cout << spi[i].bits_per_word + 0 << ", ";
    //std::cout << spi[i].cs_change + 0 << std::endl << std::endl;
}
